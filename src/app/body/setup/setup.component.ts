...
export class SetupComponent implements OnInit {
  ...
  async createNewSession(project: string, teamId: string) {
    ...
    try {
      const result = await callable({ mode: "create", TeamId: teamId, AppKey: this.appKey, Title: "1st Task", Description: "Do a task", Priority: "Medium", Difficulty: "Low", Creator: "joe", Assignee: this.email, EstimatedTime: 9, Status: "Ready to start", Project: project, SprintNumber: 1, StoryPointNumber: 9, CreationDate: "xx/xx/xxxx", Time: "07:30:21", Type: "Feature" }).toPromise();
    ...
    try {
      const result = await callable({ mode: "create", TeamId: teamId, AppKey: this.appKey, Title: "2nd Task", Description: "Do a task again", Priority: "High", Difficulty: "Medium", Creator: "joe", Assignee: this.email, EstimatedTime: 24, Status: "Ice Box", Project: project, SprintNumber: 1, StoryPointNumber: 9, CreationDate: "xx/xx/xxxx", Time: "07:30:21", Type: "UI" }).toPromise();
    ...
    try {
      const result = await callable({ mode: "create", TeamId: teamId, AppKey: this.appKey, Title: "2nd task", Description: "Do this 2nd task", Priority: "High", Difficulty: "Medium", Creator: "Mayo", Assignee: "Ketch", EstimatedTime: 8, Status: "Ready to start", Project: project, SprintNumber: 1, StoryPointNumber: 7, CreationDate: "xx/xx/xxxx", Time: "07:30:21", Type: "Feature" }).toPromise();
