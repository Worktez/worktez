 ...
 ***********************************************************/
 ...
 exports.scheduleMeet = function(request, response) {
   ...
   const promise1 = getApplicationData().then((appData) => {
     ...
     setUserMeetAtMeetWorktez(meetDocId, teamMembers, title, startTime, endTime, hostName, description, date, roomId);
     setMeetMeetAtMeetWorktez(meetDocId, teamMembers, title, startTime, endTime, hostName, description, date, roomId);
