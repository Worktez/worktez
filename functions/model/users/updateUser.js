...
exports.updateUser = function(request, response) {
    ...
    updateUser(updateUserInputJson, uid).then(() => {
        sendMail(uid, subjectMessage, htmlMessage);
