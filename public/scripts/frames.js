...
function setDataIntoCard() {
    ...
    dataset.forEach(dataObj => {
        ...
        if ((category == selectedCategory) || (status == selectedStatus)) {
            ...
            frame += "<h6 class=\"card-title text-center py-1\" > Id: </h6>";
            frame += "</div>";
            ...
            frame += "<div class=\"row pb-2\">";
            frame += "<div class=\"col-md-4 col-4\">";
            frame += "<h6 class=\"card-title text-center py-1\" > Title: </h6>";
            frame += "</div>";
            ...
            frame += "<div class=\"row pb-2\">";
            frame += "<div class=\"col-md-4 col-4\">";
            frame += "<h6 class=\"card-title text-center py-1\" > Priority: </h6>";
            frame += "</div>";
            ...
            frame += "<div class=\"row pb-2\">";
            frame += "<div class=\"col-md-4 col-4\">";
            frame += "<h6 class=\"card-title text-center py-1\" > Assignee: </h6>";
            frame += "</div>";
            ...
            frame += "<div class=\"row pb-2\">";
            frame += "<div class=\"col-md-4 col-4\">";
            frame += "<h6 class=\"card-title text-center py-1\" > Creator: </h6>";
            frame += "</div>";
